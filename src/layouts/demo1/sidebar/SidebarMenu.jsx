      ...
      return (
        <MenuItem key={index}>
          ...
          >
            <MenuIcon
              className={clsx(
                "flex justify-center items-center text-gray-600 dark:text-gray-500 menu-item-active:text-primary menu-link-hover:!text-primary",
                iconWidth
              )}
            >
              {item.icon && (
              ...
              {item.icon === "invoice" && (
                <InvoiceIcon className="h-[16px] w-[16px] text-gray-600 dark:text-gray-500 menu-item-active:text-primary menu-link-hover:!text-primary" />
              )}
            </MenuIcon>
            <MenuTitle className="text-sm font-medium text-gray-800 menu-item-active:text-primary menu-link-hover:!text-primary">
              {item.title}
