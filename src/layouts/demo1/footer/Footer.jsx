...
const Footer = () => {
  ...
  return (
    <footer className="footer bg-[#F1F1F4]">
      <Container>
        <div className="flex flex-col flex-row justify-center justify-between items-center gap-3 py-5 mx-6">
          <div className="flex order-2 md:order-1  gap-2 font-normal text-2sm">
            <span className="text-gray-500">{currentYear} &copy;</span>
            <a
              href="https://app.gamesport.com"
              target="_blank"
