...
export const PromocodesFilterContext = createContext();

export const PromocodesFilterProvider = ({ children }) => {
  ...
  return (
    <PromocodesFilterContext.Provider value={contextValue}>
      {children}
    </PromocodesFilterContext.Provider>
  );
};
